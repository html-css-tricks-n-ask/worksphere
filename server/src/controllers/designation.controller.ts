...
export const createDesignation = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const getDesignations = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const getDesignationById = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const updateDesignation = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const deleteDesignation = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const restoreDesignation = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
