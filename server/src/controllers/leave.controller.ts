...
export const getLeaveById = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const updateLeaveStatus = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  ...
  // Notify the employee
  const employee = existing.employeeId as any;
  const employeeEmail = employee?.email || '';
  const employeeName = employee?.firstName || 'Team Member';
...
export const getMyLeaves = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const getLeaveBalances = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { userId, companyId } = req.user!;
