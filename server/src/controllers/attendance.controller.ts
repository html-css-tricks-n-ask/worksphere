...
export const manualAttendance = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  ...
  const attendance = await attendanceRepository.create({
    employeeId: parsed.employeeId as any,
...
export const getMyAttendance = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { userId, companyId } = req.user!;
