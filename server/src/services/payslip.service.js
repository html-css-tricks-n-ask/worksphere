...
class PayslipService {
  generateHtmlPayslip(payroll, employeeName, employeeId, department, designation) {
  ...
  async sendPayslipEmail(email, employeeName, payroll, employeeId, department, designation) {
