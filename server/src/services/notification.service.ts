...
class NotificationService {
  async send(payload: NotificationPayload): Promise<void> {
    ...
    try {
      ...
      logger.error(`[NotificationService] Failed to send ${event} notification: ${(err as Error).message}`);
    }
  }
  ...
  private leaveAppliedTemplate(name: string, meta: Record<string, string | number | undefined>): string {
  ...
  private leaveApprovedTemplate(name: string, meta: Record<string, string | number | undefined>): string {
    return this.baseTemplate(`
  ...
  private leaveRejectedTemplate(name: string, meta: Record<string, string | number | undefined>): string {
    return this.baseTemplate(`
  ...
  private shiftAssignedTemplate(name: string, meta: Record<string, string | number | undefined>): string {
    return this.baseTemplate(`
