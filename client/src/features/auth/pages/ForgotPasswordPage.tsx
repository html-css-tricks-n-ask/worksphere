...
import { forgotPasswordSchema, ForgotPasswordInput } from '../schemas/auth.schema.js';
        ...
        <Card className="w-full max-w-md shadow-xl text-center">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              If an account with email <strong>{emailValue}</strong> exists, a password reset link has been dispatched.
            </p>
            <Link to="/login">
